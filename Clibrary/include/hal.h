...
/**
  ...
  * 		true 亮，false 灭
  */
void FMU_LED1_Control(bool status);
void FMU_LED2_Control(bool status);
void FMU_LED3_Control(bool status);
void FMU_LED4_Control(bool status);
void FMU_LED5_Control(bool status);
void FMU_LED6_Control(bool status);
void FMU_LED7_Control(bool status);
