...
CPP_SRCS += \
../Cpplibrary/filter/LowPassFilter.cpp \
../Cpplibrary/filter/LowPassFilter2p.cpp 

OBJS += \
./Cpplibrary/filter/LowPassFilter.o \
./Cpplibrary/filter/LowPassFilter2p.o 

CPP_DEPS += \
./Cpplibrary/filter/LowPassFilter.d \
./Cpplibrary/filter/LowPassFilter2p.d 


# Each subdirectory must supply rules for building sources it contributes
Cpplibrary/filter/%.o: ../Cpplibrary/filter/%.cpp Cpplibrary/filter/subdir.mk
...
clean: clean-Cpplibrary-2f-filter

clean-Cpplibrary-2f-filter:
	-$(RM) ./Cpplibrary/filter/LowPassFilter.d ./Cpplibrary/filter/LowPassFilter.o ./Cpplibrary/filter/LowPassFilter2p.d ./Cpplibrary/filter/LowPassFilter2p.o

.PHONY: clean-Cpplibrary-2f-filter
