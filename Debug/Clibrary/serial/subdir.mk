...
Clibrary/serial/%.o: ../Clibrary/serial/%.c Clibrary/serial/subdir.mk
...
clean: clean-Clibrary-2f-serial

clean-Clibrary-2f-serial:
	-$(RM) ./Clibrary/serial/serial.d ./Clibrary/serial/serial.o

.PHONY: clean-Clibrary-2f-serial
