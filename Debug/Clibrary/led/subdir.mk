...
Clibrary/led/%.o: ../Clibrary/led/%.c Clibrary/led/subdir.mk
...
clean: clean-Clibrary-2f-led

clean-Clibrary-2f-led:
	-$(RM) ./Clibrary/led/led.d ./Clibrary/led/led.o

.PHONY: clean-Clibrary-2f-led
